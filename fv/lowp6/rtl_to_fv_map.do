...
# Generated on: Tue Jun 30 22:49:04 -03 2026 (Wed Jul 01 01:49:04 UTC 2026)
...
set_log_file fv/lowp6/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/lowp6 -revised fv_map
...
read_library -liberty -both /home/holandajuan19/pi3/projeto_filtro/PI3/library/gscl45nm.lib /home/holandajuan19/pi3/projeto_filtro/PI3/library/gscl45nm.lib
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09  /home/holandajuan19/pi3/projeto_filtro/PI3/rtl/lowp6.sv
elaborate_design -golden -root {lowp6} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/lowp6/fv_map.v.gz
elaborate_design -revised -root {lowp6}
...
#add_name_alias fv/lowp6/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/lowp6/rtl_to_fv_map.log
}
